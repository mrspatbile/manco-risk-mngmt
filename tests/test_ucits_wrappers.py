...
def test_reference_data_loaders():
    ...
    print("  ✓ load_fund_profile() works (static facts and classification)")
    ...
    print("  ✓ load_regulatory_framework() works")
...
def test_srri_bucket_mapping():
    ...
    from fund_risk_workflow.risk.ucits_srri import map_volatility_to_srri_bucket
    ...
    print("  ✓ All bucket mapping tests passed")
...
def test_srri_from_returns():
    ...
    print("  ✓ SRRI computation correct")
...
def test_srri_change_trigger():
    ...
    assert trigger == True
    print("  ✓ Change trigger correctly identified")
...
def test_srri_kiid_trigger_with_disclosed_baseline():
    ...
    print("    ✓ Scenario 1: No update required")
    ...
    print("    ✓ Scenario 2: No update required (not persisted enough)")
    ...
    assert details['consecutive_months_at_current'] >= 4
    assert trigger == True
    print("    ✓ Scenario 3: Update required (changed and persisted)")

    print("  ✓ All KIID trigger scenarios correct")
